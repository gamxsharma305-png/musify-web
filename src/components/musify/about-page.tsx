  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <div className="flex flex-1 flex-col items-center px-6 py-8 text-center">
        <img src="/musify-icon.png" alt="Musify" className="size-24" />
        <h2 className="musify-title mt-4 text-3xl text-primary">Musify.</h2>
        <p className="mt-2 text-sm text-muted">Version 10.4.0</p>
        <p className="mt-6 max-w-md text-sm leading-relaxed text-fg">
          Web edition of Musify — stream songs, playlists, and radio in the browser with
          the same Material look. Original Android app by Valeri Gokadze, licensed under GPL-3.0.
        </p>
        <p className="mt-6 max-w-md text-xs leading-relaxed text-muted">
          Musify and its contributors do not host, own, or distribute copyrighted audio
